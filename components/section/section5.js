...
export default function Section5() {
    ...
    return (
        <Container style={{position:'relative',paddingBottom: '70px'}}>
            ...
            <Grid container >
                ...
                <Grid column item  lg={10} md={10} sm={10} xs={12} spacing={3}>
                        <Grid container >
                            ...
                            <Grid column   lg={4} md={4} sm={4} xs={12} spacing={3} className={styles.endColum}>
                                <div data-aos="zoom-in">
